...
export function DatePicker({ value, onChange, placeholder = "Seleccionar", disabled, className }: DatePickerProps) {
  ...
  return (
    <div className={`relative ${className || ""}`}>
      <button
        ...
        className="w-full px-3 py-2 text-left rounded-lg bg-input border border-border text-foreground text-xs md:text-sm focus:outline-none focus:ring-2 focus:ring-primary flex items-center justify-between gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
      >
